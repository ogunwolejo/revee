...
export default function Home() {
  ...
  const [prevLeftLabel, setPrevLeftLabel] = useState<string>("");
  const [prevRightLabel, setPrevRightLabel] = useState<string>("");

  const [textAnimationComplete, setTextAnimationComplete] =
    useState<boolean>(false);
  const [bgIndex, setBgIndex] = useState<number>(0);

  // constant header title
        ...
        >
          <div className="">
            <CountryMoney
              ...
              slideDirection={bgIndex % 2 === 0 ? "right" : "left"}
            />
